function [Unew, stepInfo] = update_fv_rk2(U, gridData, gamma, dt, positivity)
% update_fv_rk2
%
% Advances the conserved state by one second-order Runge-Kutta step.
%
% INPUTS:
...
rhs1 = compute_rhs(U, gridData, gamma);
U1 = U + dt .* rhs1;
...
rhs2 = compute_rhs(U1, gridData, gamma);
